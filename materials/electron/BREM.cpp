 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_numpy, __pyx_t_1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * @cython.cdivision(True)
 */
  __pyx_r = (pow(((1.0 - __pyx_v_r) / ((2.0 * __pyx_v_E0) * __pyx_v_r)), 2.0) + pow((pow(__pyx_v_Z, ((double)(1 / 3))) / (111.0 * (__pyx_v_x + 1.0))), 2.0));
  goto __pyx_L0;
 ...
 *         try:
 */
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_2, __pyx_n_s_MAP, __pyx_t_1, __pyx_t_3, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
