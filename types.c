...
if (!__Pyx_RefNanny) {
  ...
  #endif
  __Pyx_TraceCall("__Pyx_PyMODINIT_FUNC PyInit_types(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_nan); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
